...
void
cloud_cb_ (const sensor_msgs::PointCloud2& cloud)
{
  pcl::io::savePCDFile ("test.pcd", cloud, Eigen::Vector4f::Zero (),Eigen::Quaternionf::Identity (), false);
  pcl::fromROSMsg(cloud, *cloud_obj);
  new_cloud_available_flag = true;
}
...
int main (int argc, char** argv)
{
  ...
  ros::NodeHandle n;
  ros::Subscriber sub_pcl = n.subscribe("/camera/depth_registered/points",1,cloud_cb_);
